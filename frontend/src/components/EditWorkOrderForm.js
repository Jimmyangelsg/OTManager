      ...
      <div>
        ...
        {selectedFile ? (
          ...
          <div className="flex items-center gap-2">
            <Input data-testid="edit-file-upload-input" id="file-edit" type="file" onChange={(e) => e.target.files?.[0] && setSelectedFile(e.target.files[0])} className="h-10 rounded-md border-slate-300" />
